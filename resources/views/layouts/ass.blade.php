...
<body class="login-page sidebar-collapse">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/assignment/submit">Submit Assignment</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            ...
            <div class="container">
                <div class="content-center">
                    <h1 class="title">Pool of Best Writers.</h1>
        ...
        <div class="section section-about-us" style="background: #eee;">
            <div class="container">
